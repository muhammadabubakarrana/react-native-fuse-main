    ...
    return (
      <View style={styles.slide}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("ScrollDetail", {
            userDetail: item,
          })}>
          <View style={{justifyContent:"center",marginHorizontal:totalSize(1)}}>
            <Image
              source={require('../../../assets/images/main/user-5.png')}
              style={{height:48,width:48,resizeMode:"cover",borderRadius:100}}
            />
          </View>
          <View style={{flex:1,justifyContent:"center"}}>
            <Text style={{color:"#383838",fontSize:30,fontWeight:"900"}}>
              {item?.name}
            </Text>
          </View>
        </TouchableOpacity>
    ...
    <Wrapper isMain >
      ...
      <ScrollView>
        <Wrapper marginHorizontalBase marginVerticalBase>
          <Text style={{color:"#586160",fontSize:30,fontWeight:"900"}}>
            Let’s Scroll
          </Text>
          <Spacer isBasic />
          <TouchableOpacity
            ...
            style={{flexDirection:"row",backgroundColor:"#B5C6C41A",
            borderBottomLeftRadius:dropdownActive?0:24,borderBottomRightRadius:dropdownActive?0:24,
            borderTopLeftRadius:24,borderTopRightRadius:24,paddingVertical:totalSize(2),paddingHorizontal:totalSize(2)}}>
          ...
          {dropdownActive&&
            <View style={{backgroundColor:"#B5C6C41A",borderBottomLeftRadius:24,borderBottomRightRadius:24,paddingHorizontal:totalSize(2)}}>
              {dropdownData?.map((val, key) => {
                return (
                  <TouchableOpacity
                    ...
                    <View style={{justifyContent:"center",marginRight:totalSize(1)}}>
                      <Image
                        source={val?.image}
                        style={{height:40,width:40,resizeMode:"cover",borderRadius:100}}
                      />
          ...
          {tabData?.map((val, key) => {
            return (
              <TouchableOpacity
                ...
                style={{backgroundColor:activeTab===key?"#383838":"transparent",marginLeft:key===0?totalSize(2):0,marginRight:tabData?.length-1===key?totalSize(2):0,borderRadius:100,paddingVertical:totalSize(1),paddingHorizontal:totalSize(1.5)}}>
                <Text style={{color:activeTab===key?"#FFF":"#383838",fontSize:14,fontWeight:"400",textAlign:"center"}}>
                  {val?.title}
                </Text>
              </TouchableOpacity>
            )
