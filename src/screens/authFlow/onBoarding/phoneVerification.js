        ...
        <Wrapper isMain style={{flex:1,backgroundColor:"#F8F9F9",justifyContent:"center"}}>
            ...
            <Wrapper marginHorizontalBase>
                <Wrapper marginHorizontalBase>
                    ...
                    <Spacer isBasic />
                    <Spacer isBasic />
                    <View style={{flexDirection:"row",backgroundColor:"#FFF",borderColor:"#DEE1E1",borderWidth:1,borderRadius:8,paddingVertical:totalSize(1),paddingHorizontal:totalSize(1.4)}}>
                        <TouchableOpacity 
                            activeOpacity={.7}
