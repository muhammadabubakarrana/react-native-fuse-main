        ...
        <Wrapper isMain style={{flex:1,backgroundColor:"#F8F9F9"}}>
            ...
            <ScrollView 
                ...
                <View style={{flex:1,justifyContent:"center",width:Dimensions.get('window').width}}>
                    ...
                    <Spacer isBasic />
                    <Wrapper marginHorizontalBase>
                        <View style={{flexDirection:"row",borderWidth:1,borderColor:"#E6E9E9",borderRadius:100}}>
                            <TouchableOpacity
                                activeOpacity={.7}
                                onPress={() => setNotificationEnable(false)}
                                style={{flex:1,justifyContent:"center",paddingHorizontal:totalSize(1),paddingVertical:totalSize(1.4),
                                borderRadius:100,backgroundColor:!notificationEnable?colors.appColor1:"transparent"}}>
                                <Text style={{color:!notificationEnable?"#FFF":"#000000",fontSize:14,fontWeight:"400",textAlign:"center"}}>
                    ...
                    <Wrapper marginHorizontalLarge>
                        <View style={{flexDirection:"row"}}>
                            <TouchableOpacity
                                ...
                                style={{flex:1,justifyContent:"center",paddingHorizontal:totalSize(1),height:153,marginRight:8,borderWidth:userType===0?0:1,
                                borderColor:"#E6E9E9",alignItems:"center",borderRadius:10,backgroundColor:userType===0?colors.appColor1:"transparent"}}>
                                <SvgIcons.DualHeartIcon fillColor={userType===0?"#F8F9F9":"#3F3F46"} />
                                <Spacer isBasic />
                                <Text style={{color:userType===0?"#FFF":"#000000",fontSize:14,fontWeight:"400",textAlign:"center"}}>
                                    Fusing{`\n`}Matchmaker
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                ...
                                style={{flex:1,justifyContent:"center",paddingHorizontal:totalSize(1),height:153,marginLeft:8,borderWidth:userType===1?0:1,
                                borderColor:"#E6E9E9",alignItems:"center",borderRadius:10,backgroundColor:userType===1?colors.appColor1:"transparent"}}>
                                <SvgIcons.HeartIcon fillColor={userType===1?"#F8F9F9":"#3F3F46"} />
                                <Spacer isBasic />
                                <Text style={{color:userType===1?"#FFF":"#000000",fontSize:14,fontWeight:"400",textAlign:"center"}}>
                                    Getting fused{`\n`}Dater
                                </Text>
                            </TouchableOpacity>
                        </View>
