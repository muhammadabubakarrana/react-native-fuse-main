    ...
    return (
        <Wrapper isMain style={{flex:1,backgroundColor:"#F8F9F9",justifyContent:"center"}}>
            ...
            <TouchableOpacity
                ...
                <Text style={{color:"#6C7473",fontSize:14,fontWeight:"400",textAlign:"center"}}>
                    Back To Login
                </Text>
            </TouchableOpacity>
            <Modal
                ...
                onBackdropPress={() => {}}>
                <View style={{backgroundColor:"#FFF",paddingHorizontal:totalSize(6),paddingVertical:totalSize(4),borderRadius:20}}>
                    <Text style={{color:"#3F3F46",fontSize:14,fontWeight:"400",textAlign:"center",lineHeight:22.4}}>
                        Password Reset link sent on email hello@email.com, please check your email to reset the password
                    </Text>
                    <Spacer isBasic />
                    <Spacer isBasic />
                    <Buttons.Colored
