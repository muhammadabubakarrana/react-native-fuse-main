...
export const appStyles = StyleSheet.create({
  ...
  h1: {
    ...
    lineHeight: fontSize.h1+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextBold
  },
  h2: {
    fontSize: fontSize.h2,
    lineHeight: fontSize.h2+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextBold
  },
  h3: {
    fontSize: fontSize.h3,
    lineHeight: fontSize.h3+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextBold
  },
  h4: {
    fontSize: fontSize.h4,
    lineHeight: fontSize.h4+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextBold
  },
  h5: {
    fontSize: fontSize.h5,
    lineHeight: fontSize.h5+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextBold
  },
  h6: {
    fontSize: fontSize.h6,
    lineHeight: fontSize.h6+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextBold
  },
  textLarge: {
    fontSize: fontSize.large,
    lineHeight: fontSize.large+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
  textMedium: {
    fontSize: fontSize.medium,
    lineHeight: fontSize.medium+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
  textRegularPlus: {
  ...
  textRegular: {
    ...
    lineHeight: fontSize.regular+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
  textSmallPlus: {
  ...
  textSmall: {
    ...
    lineHeight:fontSize.small+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
  textTiny: {
    fontSize: fontSize.tiny,
    lineHeight:fontSize.tiny+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
  xTinyText: {
    fontSize: fontSize.xTiny,
    lineHeight: fontSize.xTiny+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
  xxTinyText: {
    fontSize: fontSize.xxTiny,
    lineHeight: fontSize.xxTiny+totalSize(0.5),
    color: colors.appTextColor1,
    fontFamily: fontFamily.appTextRegular
  },
