...
import { colors, appStyles, sizes, fontSize, appIcons } from "../../services";
    ...
    >
      {title ? (
        <Wrapper style={{ marginHorizontal: 0 }}>
          <Text isInput style={[{color:"#586160",fontSize:14,fontWeight:400}, titleStyle]}>
            {title}
          </Text>
          <Spacer isTiny />
        </Wrapper>
          ...
          {right ? (
            ...
            >
              <Icons.Custom
                ...
                color={iconColorRight || colors.appTextColor1}
...
const SearchBar = ({
  ...
  return (
    <Colored
      ...
      right={
        right || (
          <Wrapper
            flexDirectionRow
            alignItemsCenter
            style={{ marginRight: height(0.5) }}
          >
            <Icons.Custom
              icon={appIcons.close}
              size={totalSize(3.5)}
              onPress={onPressCross}
              containerStyle={{ opacity: value && onPressCross ? 1 : 0.5 }}
            />
            <Spacer isSmall horizontal />
            <Spacer isTiny horizontal />
            <Icons.Custom
              icon={appIcons.search_circle}
              size={sizes.inputHeight - height(1.5)}
      ...
      inputStyle={[
        {
          height: sizes.inputHeight - height(1),
    ...
    >
      ...
      <Wrapper style={{ flex: 1, justifyContent: "center" }}>
        <TextInput
          ...
          onChangeText={onChangeText}
          placeholder={placeholder ? placeholder : "Search"}
          placeholderTextColor={colors.appTextColor7}
          {...props}
          style={{
...
export { Colored, Bordered, Underlined, SearchBar, SearchInput };
