...
import { colors, appStyles, sizes, AppSvgs, appIcons } from '../../services';
...
export const WithText = ({ text, containerStyle, title, customIcon, onPress, tintColor, svgIcon, iconName, iconType, iconSize, textStyle, titleStyle, direction,icon, iconStyle, textContainerStyle }) => {
    const SvgIcon = svgIcon
