                ...
                <Wrapper style={{ flexDirection: direction ? direction : 'row', alignItems: 'center' }}>
                    ...
                    }
                    {
                        isLoading ?
                            ...
                            />
                            :
                            <Text isButtonMedium style={[{ color: tintColor ? tintColor : colors.appTextColor6, fontSize:14,fontWeight:400 }, textStyle]}>{text}</Text>
                    }
                </Wrapper>
            </Wrapper>
        </TouchableOpacity>
...
export {ButtonGroupAnimated,ButtonGroup}